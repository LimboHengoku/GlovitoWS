...
public class CategoriaController {
	...
	public ResponseEntity<CodigoGeneradoResponse> registrarCategoria(@RequestBody RegistrarCategoriaRequest req) {
		...
		try {
			...
			response = productoService.registrarCategoria(idTransaccion, req);
